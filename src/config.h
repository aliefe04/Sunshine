...
namespace config {
  ...
  struct audio_t {
    ...
    bool mic_passthrough;  ///< Enable microphone passthrough from client to host
    std::string mic_virtual_device;  ///< Virtual audio device name for mic output (e.g., "CABLE Input (VB-Audio Virtual Cable)")
  };
